...
public:
    ...
    bool get_request_uri_path(String& outPath);
    void set_request_uri_path(const String& path);

private:
    Document mDocument = {};
    EUIScroll mScroll;
    Vector<EUIDocumentItem> mItems;
    String mRequestURIPath = {}; // if not empty, user should rebuild from the requested URI
};
