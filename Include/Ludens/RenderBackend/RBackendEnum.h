...
enum RPipelineStageBit : RPipelineStageFlags
{
    ...
    RPIPELINE_STAGE_TRANSFER_BIT = 32,
    RPIPELINE_STAGE_BOTTOM_OF_PIPE_BIT = 64,
    RPIPELINE_STAGE_BITS_ENUM_LAST_BIT = 128,
};
...
enum RAccessBit : RAccessFlags
{
    ...
    RACCESS_COLOR_ATTACHMENT_READ_BIT = 8,
    RACCESS_COLOR_ATTACHMENT_WRITE_BIT = 16,
    RACCESS_TRANSFER_READ_BIT = 32,
    RACCESS_TRANSFER_WRITE_BIT = 64,
    RACCESS_BITS_ENUM_LAST_BIT = 128,
};
