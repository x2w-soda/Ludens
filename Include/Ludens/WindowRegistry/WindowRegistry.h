...
using WindowRegistryObserver = std::pair<WindowEventFn, void*>;

struct WindowInfo
{
    const char* name;            /// initial window name
    void* user;                  /// arbitrary user data during callbacks
    WindowEventFn onEvent;       /// window event callback
...
struct WindowRegistry : Handle<struct WindowRegistryObj>
{
    ...
    /// @brief Add an observer to receive window events generated by the registry.
