...
struct ProjectSchema
{
    ...
    static std::string create_empty(const std::string& projectName, const std::string& assetSchemaPath, const std::string& sceneSchemaPath, const std::string& sceneName);
};
