...
function(add_ludens_builder_module_test)
    cmake_parse_arguments(MODULE "" "TEST_NAME" "TEST" ${ARGN})
    message(STATUS "LUDENS BUILDER MODULE TEST  ${MODULE_TEST_NAME}")
    add_executable(${MODULE_TEST_NAME} ${MODULE_TEST})
    target_include_directories(${MODULE_TEST_NAME} PRIVATE ${LUDENS_INCLUDE_DIR} ${LUDENS_SOURCE_DIR})
    target_link_libraries(${MODULE_TEST_NAME} PUBLIC LDCoreLibs)
    target_link_options(${MODULE_TEST_NAME} PRIVATE ${MODULE_LINK_OPTIONS})
    set_target_properties(${MODULE_TEST_NAME} PROPERTIES FOLDER ${LD_BUILDER_MODULE_FOLDER})
endfunction()
