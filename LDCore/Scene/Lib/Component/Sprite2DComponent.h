...
struct Sprite2DMeta
{
    ...
    static bool load_suid(SceneObj* scene, Sprite2DComponent* sprite, SUID layerSUID, AssetID texture2D, String& err);
    static bool load_ruid(SceneObj* scene, Sprite2DComponent* sprite, RUID layerRUID, AssetID texture2D, String& err);
    ...
    static bool unload(SceneObj* scene, ComponentBase** data, String& err);
